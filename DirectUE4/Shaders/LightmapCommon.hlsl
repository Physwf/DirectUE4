...
#include "VolumetricLightmapShared.hlsl"
...
half4 GetPrecomputedShadowMasks(VertexFactoryInterpolantsVSToPS Interpolants, float3 WorldPosition, float3 VolumetricLightmapBrickTextureUVs)
{

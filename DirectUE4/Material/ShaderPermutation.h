...
struct FShaderPermutationBool
{
	...
	*/
	...
	{
		assert(PermutationId == 0 || PermutationId == 1);// , TEXT("Invalid shader permutation dimension id %i."), PermutationId);
...
struct TShaderPermutationInt
{
	...
	*/
	...
	static int32 ToDimensionValueId(Type E)
	{
		...
		assert(PermutationId < PermutationCount && PermutationId >= 0);// , TEXT("Unknown shader permutation dimension value id %i."), PermutationId);
	...
	static Type FromDimensionValueId(int32 PermutationId)
	{
		assert(PermutationId < PermutationCount && PermutationId >= 0);//, TEXT("Invalid shader permutation dimension value id %i."), PermutationId);
...
struct TShaderPermutationSparseInt
{
	...
	*/
	...
	static int32 ToDimensionValueId(Type E)
	{
		assert(false);//, TEXT("Unknown shader permutation dimension value %i."), E);
		return int32(0);
	}
	...
	static Type FromDimensionValueId(int32 PermutationId)
	{
		assert(false);// , TEXT("Invalid shader permutation dimension id %i."), PermutationId);
		return Type(0);
	}
};
...
struct TShaderPermutationDomain
{
	...
	*/
	...
	{
		assert(PermutationId == 0);//, TEXT("Invalid shader permutation id %i."), PermutationId);
	}
...
struct TShaderPermutationDomain<TDimension, Ts...>
{
	...
	*/
	...
	{
		assert(PermutationId >= 0 && PermutationId < PermutationCount);// , TEXT("Invalid shader permutation id %i."), PermutationId);
	}
